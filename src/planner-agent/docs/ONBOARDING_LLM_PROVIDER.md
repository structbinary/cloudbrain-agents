...
This guide explains how to add ("onboard") a new LLM provider to the `planner_agent` project using the established abstract base class pattern.
...
- **Location:** `planner_agent/core/llm/`
...
## References
- [base_llm_provider.py](../planner_agent/core/llm/base_llm_provider.py)
- [llm_provider.py](../planner_agent/core/llm/llm_provider.py)

---

For questions, contact the project maintainers or check the latest provider implementations for reference. 