...
class ValidationError(PlannerAgentError):
...
class ConfigError(PlannerAgentError):
    """Raised for configuration-related errors."""
    pass

# Aliases for backward compatibility (if needed)
# (If you previously imported these from models/errors.py, import from here instead)
# ValidationError, MessageFormatError, JsonRpcValidationError, A2AProtocolError
# LLMConfigurationError, UnsupportedProviderError, ConfigError
