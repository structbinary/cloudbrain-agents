...
# async def main():
#     """Example usage of the MCPAdapterClient."""
#     async with create_mcp_client(host='localhost', port='8080', transport='sse') as client:
...
#         for agent in agents[:2]:  # Show first 2 agents only
